...
<link rel="stylesheet" href="{{asset('Dashboard/assets/css/linearicons.css')}}">
<link rel="stylesheet" href="{{asset('Dashboard/assets/css/flaticon.css')}}">
<link rel="stylesheet" href="{{asset('Dashboard/assets/css/simple-line-icons.css')}}">
<!--- owl carousel CSS-->
<link rel="stylesheet" href="{{asset('Dashboard/assets/owlcarousel/css/owl.carousel.min.css')}}">
<link rel="stylesheet" href="{{asset('Dashboard/assets/owlcarousel/css/owl.theme.css')}}">
<link rel="stylesheet" href="{{asset('Dashboard/assets/owlcarousel/css/owl.theme.default.min.css')}}">
<!-- Magnific Popup CSS -->
<link rel="stylesheet" href="{{asset('Dashboard/assets/css/magnific-popup.css')}}">
<!-- Slick CSS -->
<link rel="stylesheet" href="{{asset('Dashboard/assets/css/slick.css')}}">
<link rel="stylesheet" href="{{asset('Dashboard/assets/css/slick-theme.css')}}">
<!-- Style CSS -->
