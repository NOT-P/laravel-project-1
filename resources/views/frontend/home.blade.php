        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-sm-5">
                    	<div class="background_bg h-100" data-img-src="{{asset('Dashboard/assets/images/popup_img3.jpg')}}"></div>
                    </div>
                </div>
            </div>
    	</div>
                	...
                	<div class="d-flex align-items-center justify-content-center justify-content-md-end">
                        <div class="lng_dropdown">
                            <select name="countries" class="custome_select">
                                <option value='en' data-image="{{asset('Dashboard/assets/images/eng.png')}}" data-title="English">English</option>
                                <option value='fn' data-image="{{asset('Dashboard/assets/images/fn.png')}}" data-title="France">France</option>
                                <option value='us' data-image="{{asset('Dashboard/assets/images/us.png')}}" data-title="United States">United States</option>
                            </select>
                        </div>
                        <div class="ms-3">
                            <select name="countries" class="custome_select">
    	...
    	<div class="container">
            <div class="nav_block">
                <a class="navbar-brand" href="index.html">
                    <img class="logo_light" src="{{asset('Dashboard/assets/images/logo_light.png')}}" alt="logo">
                    <img class="logo_dark" src="{{asset('Dashboard/assets/images/logo_dark.png')}}" alt="logo">
                </a>
                        ...
                        <div class="cart_box cart_right dropdown-menu dropdown-menu-right">
                            <ul class="cart_list">
                                <li>
                                    ...
                                    <a href="#"><img src="{{asset('Dashboard/assets/images/cart_thamb1.jpg')}}" alt="cart_thumb1">Variable product 001</a>
                                    <span class="cart_quantity"> 1 x <span class="cart_amount"> <span class="price_symbole">$</span></span>78.00</span>
                                </li>
                                <li>
                                    <a href="#" class="item_remove"><i class="ion-close"></i></a>
                                    <a href="#"><img src="{{asset('Dashboard/assets/images/cart_thamb2.jpg')}}" alt="cart_thumb2">Ornare sed consequat</a>
                                        ...
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="{{asset('Dashboard/assets/images/menu_banner7.jpg')}}" alt="menu_banner1">
                                                ...
                                                <div class="header-banner2">
                                                    <img src="{{asset('Dashboard/assets/images/menu_banner8.jpg')}}" alt="menu_banner2">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Top Laptops</h4>
                                                        <a href="#">Shop now</a>
                                ...
                                <li class="dropdown dropdown-mega-menu">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <a href="#"><img src="{{asset('Dashboard/assets/images/menu_banner6.jpg')}}" alt="menu_banner"></a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li class="dropdown dropdown-mega-menu">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <a href="#"><img src="{{asset('Dashboard/assets/images/menu_banner9.jpg')}}" alt="menu_banner"></a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <div class="d-lg-flex menu_banners row g-3 px-3">
                                                ...
                                                <div class="header-banner">
                                                    <div class="sale-banner">
                                                        <a class="hover_effect1" href="#">
                                                            <img src="{{asset('Dashboard/assets/images/shop_banner_img7.jpg')}}" alt="shop_banner_img7">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="header-banner">
                                                    <div class="sale-banner">
                                                        <a class="hover_effect1" href="#">
                                                            <img src="{{asset('Dashboard/assets/images/shop_banner_img8.jpg')}}" alt="shop_banner_img8">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="header_banner_content">
                                                        <div class="shop_banner">
                                                            <div class="banner_img overlay_bg_40">
                                                                <img src="{{asset('Dashboard/assets/images/shop_banner4.jpg')}}" alt="shop_banner2"/>
                                                            </div> 
...
<div class="banner_section slide_medium shop_banner_slider staggered-animation-wrap">
    <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item background_bg active" data-img-src="{{asset('Dashboard/assets/images/banner16.jpg')}}">
            ...
            <div class="carousel-item background_bg" data-img-src="{{asset('Dashboard/assets/images/banner17.jpg')}}">
                <div class="banner_slide_content banner_content_inner">
                	<div class="container">
                    	<div class="row">
            ...
            <div class="carousel-item background_bg" data-img-src="{{asset('Dashboard/assets/images/banner18.jpg')}}">
                <div class="banner_slide_content banner_content_inner">
                	<div class="container">
                    	<div class="row">
                    		<div class="col-lg-8 col-10">
	...
	<div class="container">
    	<div class="row">
            ...
            <div class="col-md-4">
            	<div class="sale-banner mb-3 mb-md-4">
                	<a class="hover_effect1" href="#">
                		<img src="{{asset('Dashboard/assets/images/shop_banner_img9.jpg')}}" alt="shop_banner_img9">
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="cat_slider cat_style1 mt-4 mt-md-0 carousel_slider owl-carousel owl-theme nav_style5" data-loop="true" data-dots="false" data-nav="true" data-margin="30" data-responsive='{"0":{"items": "2"}, "480":{"items": "3"}, "576":{"items": "4"}, "768":{"items": "5"}, "991":{"items": "6"}, "1199":{"items": "7"}}'>
                    <div class="item">
                        <div class="categories_box">
                            <a href="#">
                                <img src="{{asset('Dashboard/assets/images/cat_img1.png')}}" alt="cat_img1"/>
                    ...
                    <div class="item">
                        <div class="categories_box">
                            <a href="#">
                                <img src="{{asset('Dashboard/assets/images/cat_img2.png')}}" alt="cat_img2"/>
                                <span>Mobile</span>
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="categories_box">
                            <a href="#">
                                <img src="{{asset('Dashboard/assets/images/cat_img3.png')}}" alt="cat_img3"/>
                                <span>Headphone</span>
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="categories_box">
                            <a href="#">
                                <img src="{{asset('Dashboard/assets/images/cat_img4.png')}}" alt="cat_img4"/>
                                <span>Watch</span>
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="categories_box">
                            <a href="#">
                                <img src="{{asset('Dashboard/assets/images/cat_img5.png')}}" alt="cat_img5"/>
                                <span>Game</span>
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="categories_box">
                            <a href="#">
                                <img src="{{asset('Dashboard/assets/images/cat_img6.png')}}" alt="cat_img6"/>
                                <span>Camera</span>
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="categories_box">
                            <a href="#">
                                <img src="{{asset('Dashboard/assets/images/cat_img7.png')}}" alt="cat_img7"/>
                                <span>Audio</span>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
                                ...
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('Dashboard/assets/images/el_img1.jpg')}}" alt="el_img1">
                                            <img class="product_hover_img" src="{{asset('Dashboard/assets/images/el_hover_img1.jpg')}}" alt="el_hover_img1">
                                        </a>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('Dashboard/assets/images/el_img2.jpg')}}" alt="el_img2">
                                            <img class="product_hover_img" src="{{asset('Dashboard/assets/images/el_hover_img2.jpg')}}" alt="el_hover_img2">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('Dashboard/assets/images/el_img3.jpg')}}" alt="el_img3">
                                            <img class="product_hover_img" src="{{asset('Dashboard/assets/images/el_hover_img3.jpg')}}" alt="el_hover_img3">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('Dashboard/assets/images/el_img4.jpg')}}" alt="el_img4">
                                            <img class="product_hover_img" src="{{asset('Dashboard/assets/images/el_hover_img4.jpg')}}" alt="el_hover_img4">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('Dashboard/assets/images/el_img5.jpg')}}" alt="el_img5">
                                            <img class="product_hover_img" src="{{asset('Dashboard/assets/images/el_hover_img5.jpg')}}" alt="el_hover_img5">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('Dashboard/assets/images/el_img6.jpg')}}" alt="el_img6">
                                            <img class="product_hover_img" src="{{asset('Dashboard/assets/images/el_hover_img6.jpg')}}" alt="el_hover_img6">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                        ...
                        <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
                            <div class="item">
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('Dashboard/assets/images/el_img7.jpg')}}" alt="el_img7">
                                            <img class="product_hover_img" src="{{asset('Dashboard/assets/images/el_hover_img7.jpg')}}" alt="el_hover_img7">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('Dashboard/assets/images/el_img8.jpg')}}" alt="el_img8">
                                            <img class="product_hover_img" src="{{asset('Dashboard/assets/images/el_hover_img8.jpg')}}" alt="el_hover_img8">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('Dashboard/assets/images/el_img9.jpg')}}" alt="el_img9">
                                            <img class="product_hover_img" src="{{asset('Dashboard/assets/images/el_hover_img9.jpg')}}" alt="el_hover_img9">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('Dashboard/assets/images/el_img10.jpg')}}" alt="el_img10">
                                            <img class="product_hover_img" src="{{asset('Dashboard/assets/images/el_hover_img10.jpg')}}" alt="el_hover_img10">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('Dashboard/assets/images/el_img11.jpg')}}" alt="el_img11">
                                            <img class="product_hover_img" src="{{asset('Dashboard/assets/images/el_hover_img11.jpg')}}" alt="el_hover_img11">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('Dashboard/assets/images/el_img12.jpg')}}" alt="el_img12">
                                            <img class="product_hover_img" src="{{asset('Dashboard/assets/images/el_hover_img12.jpg')}}" alt="el_hover_img12">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
	...
	<div class="container">
    	<div class="row">
        	<div class="col-12">
            	<div class="sale-banner mb-3 mb-md-4">
                	<a class="hover_effect1" href="#">
                		<img src="{{asset('Dashboard/assets/images/shop_banner_img11.png')}}" alt="shop_banner_img11">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-9">
            	<div class="testimonial_wrap testimonial_style1 carousel_slider owl-carousel owl-theme nav_style2" data-nav="true" data-dots="false" data-center="true" data-loop="true" data-autoplay="true" data-items='1'>
                	<div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="{{asset('Dashboard/assets/images/user_img1.jpg')}}" alt="user_img1" />
                            </div>
                    ...
                    <div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="{{asset('Dashboard/assets/images/user_img2.jpg')}}" alt="user_img2" />
                            </div>
                            <div class="author_name">
                                <h6>Alden Smith</h6>
                                <span>Designer</span>
                    ...
                    <div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="{{asset('Dashboard/assets/images/user_img3.jpg')}}" alt="user_img3" />
                            </div>
                            <div class="author_name">
                                <h6>Daisy Lana</h6>
                                <span>Designer</span>
                    ...
                    <div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="{{asset('Dashboard/assets/images/user_img4.jpg')}}" alt="user_img4" />
                            </div>
                            <div class="author_name">
                                <h6>John Becker</h6>
                                <span>Designer</span>
        ...
        <div class="row justify-content-center">
            	...
            	<div class="blog_post blog_style2 box_shadow1">
                	<div class="blog_img">
                        <a href="blog-single.html">
                            <img src="{{asset('Dashboard/assets/images/el_blog_img1.jpg')}}" alt="el_blog_img1">
                        </a>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
            	<div class="blog_post blog_style2 box_shadow1">
                	<div class="blog_img">
                        <a href="blog-single.html">
                            <img src="{{asset('Dashboard/assets/images/el_blog_img2.jpg')}}" alt="el_blog_img2">
                        </a>
                    </div>
                    <div class="blog_content bg-white">
                    	<div class="blog_text">
            ...
            <div class="col-lg-4 col-md-6">
            	<div class="blog_post blog_style2 box_shadow1">
                	<div class="blog_img">
                        <a href="blog-single.html">
                            <img src="{{asset('Dashboard/assets/images/el_blog_img3.jpg')}}" alt="el_blog_img2">
                        </a>
                    </div>
                    <div class="blog_content bg-white">
                    	<div class="blog_text">
        ...
        <div class="row">
        	<div class="col-12">
            	<div class="client_logo carousel_slider owl-carousel owl-theme" data-dots="false" data-margin="30" data-loop="true" data-autoplay="true" data-responsive='{"0":{"items": "2"}, "480":{"items": "3"}, "767":{"items": "4"}, "991":{"items": "5"}}'>
                	<div class="item">
                    	<div class="cl_logo">
                        	<img src="{{asset('Dashboard/assets/images/cl_logo1.png')}}" alt="cl_logo"/>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cl_logo">
                        	<img src="{{asset('Dashboard/assets/images/cl_logo2.png')}}" alt="cl_logo"/>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cl_logo">
                        	<img src="{{asset('Dashboard/assets/images/cl_logo3.png')}}" alt="cl_logo"/>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cl_logo">
                        	<img src="{{asset('Dashboard/assets/images/cl_logo4.png')}}" alt="cl_logo"/>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cl_logo">
                        	<img src="{{asset('Dashboard/assets/images/cl_logo5.png')}}" alt="cl_logo"/>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cl_logo">
                        	<img src="{{asset('Dashboard/assets/images/cl_logo6.png')}}" alt="cl_logo"/>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cl_logo">
                        	<img src="{{asset('Dashboard/assets/images/cl_logo7.png')}}" alt="cl_logo"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12">
                	<div class="widget">
                        <div class="footer_logo">
                            <a href="#"><img src="{{asset('Dashboard/assets/images/logo_dark.png')}}" alt="logo"/></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                	<div class="widget">
                        ...
                        <ul class="app_list">
                            <li><a href="#"><img src="{{asset('Dashboard/assets/images/f1.png')}}" alt="f1"/></a></li>
                            <li><a href="#"><img src="{{asset('Dashboard/assets/images/f2.png')}}" alt="f2"/></a></li>
                        </ul>
                    </div>
                	<div class="widget">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ul class="footer_payment text-center text-md-end">
                        <li><a href="#"><img src="{{asset('Dashboard/assets/images/visa.png')}}" alt="visa"></a></li>
                        <li><a href="#"><img src="{{asset('Dashboard/assets/images/discover.png')}}" alt="discover"></a></li>
                        <li><a href="#"><img src="{{asset('Dashboard/assets/images/master_card.png')}}" alt="master_card"></a></li>
                        <li><a href="#"><img src="{{asset('Dashboard/assets/images/paypal.png')}}" alt="paypal"></a></li>
                        <li><a href="#"><img src="{{asset('Dashboard/assets/images/amarican_express.png')}}" alt="amarican_express"></a></li>
                    </ul>
                </div>
            </div>
        </div>
